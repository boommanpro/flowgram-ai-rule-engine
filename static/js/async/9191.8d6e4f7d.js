/*! For license information please see 9191.8d6e4f7d.js.LICENSE.txt */
"use strict";(self.webpackChunkconsole=self.webpackChunkconsole||[]).push([["9191"],{42922(e,t,a){a.r(t),a.d(t,{conf:()=>r,language:()=>_});var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function o(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var n=o("true false"),i=o(`
			  alias
			  break
			  case
			  const
